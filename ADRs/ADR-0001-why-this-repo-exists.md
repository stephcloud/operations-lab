...
## Decision
I will maintain a single monolithic repo called `operations-lab` that contains every module's labs, runbooks, screenshots, and writeups. Each module gets a numbered folder. Each lab gets its own subfolder with a README. Every artifact is reproducible from the README.
